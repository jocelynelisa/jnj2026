            ...
            <ul className="map-locations">
              <li className="location-item">
                ...
                <div className="location-text">
                  <strong>Cathédrale Ste Trinité:</strong>
              ...
              <li className="location-item">
                ...
                <div className="location-text">
                  ...
                  <span>Accueil:Archidiocèse de Lomé, diocèse de Kara et les reste d'Atakpamé.</span>
                </div>
              </li>
              <li className="location-item">
                <MapPin size={18} className="location-icon" />
                <div className="location-text">
                  <strong>Paroisse Sainte famille: </strong>
                  <span>Accueil: Diocèse de Dapaong et diocèse de Kpalimé et une partie d'Atakpamé.</span>
                </div>
              </li>
            </ul>
