            ...
            <ul className="map-locations">
              <li className="location-item">
                ...
                <div className="location-text">
                  ...
                  <span>Lieu principal d'adoration et de célébrations liturgiques.</span>
                </div>
              </li>
              <li className="location-item">
                <MapPin size={18} className="location-icon" />
                <div className="location-text">
                  <strong>Stade Municipal d'Atakpamé</strong>
                  <span>Lieu du grand rassemblement d'ouverture et de clôture.</span>
                </div>
              </li>
              <li className="location-item">
                <MapPin size={18} className="location-icon" />
                <div className="location-text">
                  <strong>Colline d'Atakpamé</strong>
                  <span>Le grand chemin de croix des jeunes.</span>
                </div>
              </li>
            </ul>
